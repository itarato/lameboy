...
impl VM {
    ...
    fn exec_op(&mut self) -> Result<(), Error> {
        ...
        match op {
            ...
            0x0A => {
                // LD A,(BC) 1 8 | - - - -
                unimplemented!("Opcode 0x0A (LD A,(BC) 1 8) not implemented");
            }
            0x0B => {
                // DEC BC 1 8 | - - - -
            ...
            0x1A => {
                // LD A,(DE) 1 8 | - - - -
                unimplemented!("Opcode 0x1A (LD A,(DE) 1 8) not implemented");
            }
            0x1B => {
                // DEC DE 1 8 | - - - -
            ...
            0x36 => {
                // LD (HL),d8 2 12 | - - - -
                unimplemented!("Opcode 0x36 (LD (HL),d8 2 12) not implemented");
            }
            0x37 => {
                // SCF 1 4 | - 0 0 1
            ...
            0x80 => {
                // ADD A,B 1 4 | Z 0 H C
                unimplemented!("Opcode 0x80 (ADD A,B 1 4) not implemented");
            }
            0x81 => {
                // ADD A,C 1 4 | Z 0 H C
                unimplemented!("Opcode 0x81 (ADD A,C 1 4) not implemented");
            }
            0x82 => {
                // ADD A,D 1 4 | Z 0 H C
                unimplemented!("Opcode 0x82 (ADD A,D 1 4) not implemented");
            }
            0x83 => {
                // ADD A,E 1 4 | Z 0 H C
                unimplemented!("Opcode 0x83 (ADD A,E 1 4) not implemented");
            }
            0x84 => {
                // ADD A,H 1 4 | Z 0 H C
                unimplemented!("Opcode 0x84 (ADD A,H 1 4) not implemented");
            }
            0x85 => {
                // ADD A,L 1 4 | Z 0 H C
                unimplemented!("Opcode 0x85 (ADD A,L 1 4) not implemented");
            }
            0x86 => {
            ...
            0x87 => {
                // ADD A,A 1 4 | Z 0 H C
                unimplemented!("Opcode 0x87 (ADD A,A 1 4) not implemented");
            }
            0x88 => {
                // ADC A,B 1 4 | Z 0 H C
